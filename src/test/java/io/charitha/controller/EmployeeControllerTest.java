package io.charitha.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import io.charitha.entity.Employee;
import io.charitha.repository.EmployeeRepository;
...
public class EmployeeControllerTest {
    ...
    public void setup() {
        ...
        emp.setEmail("jsmith@charitha.io");
        repository.save(emp);
    }
    ...
    public void findAll() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/employees"))
           ...
           .andExpect(MockMvcResultMatchers.jsonPath("$[0].email", Matchers.is("jsmith@charitha.io")));
    }
    ...
    public void findOne() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/employees/jsmith-id"))
           .andExpect(MockMvcResultMatchers.status()
                                           .isOk())
           .andExpect(MockMvcResultMatchers.jsonPath("$.email", Matchers.is("jsmith@charitha.io")));
    }
    ...
    public void create() throws Exception {
        ...
        emp.setEmail("psalitra@charitha.io");
        ...
        mvc.perform(MockMvcRequestBuilders.post("/employees")
           ...
           .andExpect(MockMvcResultMatchers.jsonPath("$.email", Matchers.is("psalitra@charitha.io")));
